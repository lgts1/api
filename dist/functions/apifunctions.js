...
exports.default = {
    ...
    createuser(user_code, tokenuser, atkuser, balance, agentid) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield database_1.default.query("INSERT INTO users (username,token,atk,saldo,agentid,isinfluencer) VALUES(?,?,?,?,?,1)", [user_code, tokenuser, atkuser, balance, agentid]);
            return res[0];
        });
    },
