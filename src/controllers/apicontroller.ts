         ...
         if (user.length === 0) {
            ...
            if (createnewuser.affectedRows >= 1) {
               ...
               res.send({
                  status: 1,
                  msg: "SUCCESS",
                  launch_url: `https://api.bet-sandbox.online/${codegame}/index.html?language=pt&bet_type=1&operator_token=568EA72A-C06B-4E4F-9779-0B9BCB2FEBAD&operator_player_session=pgsoft170910707623418458473751&t=${getnewuser[0].token}&f=&oc=0&iwk=1&__refer=api.bet-sandbox.online&or=api.bet-sandbox.online&__hv=1f819bc7`,
            ...
            res.send({
               status: 1,
               msg: "SUCCESS",
               launch_url: `https://api.bet-sandbox.online/${codegame}/index.html?language=pt&bet_type=1&operator_token=568EA72A-C06B-4E4F-9779-0B9BCB2FEBAD&operator_player_session=pgsoft170910707623418458473751&t=${user[0].token}&f=&oc=0&iwk=1&__refer=api.bet-sandbox.online&or=api.bet-sandbox.online&__hv=1f819bc7`,
